...
from relax.network.sac_vbl import SACVBLNet, SACVBLParams
from relax.utils.experience import Experience
from relax.utils.typing import Metric


class SACVBLOptStates(NamedTuple):
    q1: optax.OptState
    q2: optax.OptState
...
class SACVBLTrainState(NamedTuple):
    params: SACVBLParams
    opt_state: SACVBLOptStates
    step: int
    ...
    def __init__(
        ...
        *,
        ...
        def stateless_update(
            key: jax.random.KeyArray, state: SACVBLTrainState, data: Experience
        ) -> Tuple[SACVBLTrainState, Metric]:
